    ...
    override suspend fun load(
        ...
        try {
            ...
            database.withTransaction {
                ...
                val storiesEntity = responseData.listStory.toEntityList()
                database.getStoryDao().insertStory(storiesEntity)
            }
